...
const Sidebar = () => {
  ...
  return (
    <motion.div
      ...
      className="h-screen bg-brand-surface border-r border-brand-border flex flex-col justify-between text-gray-300 relative select-none"
    >
      {/* Sidebar Collapse Toggle */}
      <button 
        onClick={() => setCollapsed(!collapsed)}
        className="absolute top-4 -right-3 bg-brand-surface border border-brand-border text-gray-400 hover:text-white rounded-full p-1 cursor-pointer z-50 hover:bg-brand-border transition-colors"
      >
